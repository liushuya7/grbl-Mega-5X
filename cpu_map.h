...
#define cpu_map_h
...
#ifdef CPU_MAP_GRBLDUINO_BOARD // GRBLDuino @ BIGSS
  ...
  // #if N_AXIS > 3
  //   #define LIMIT_MASK ((1<<MIN_LIMIT_BIT_0)|(1<<MAX_LIMIT_PORT_0)|(1<<MIN_LIMIT_BIT_1)|(1<<MAX_LIMIT_PORT_1)|(1<<MIN_LIMIT_BIT_2)|(1<<MAX_LIMIT_PORT_2)|(1<<MIN_LIMIT_BIT_3)|(1<<MAX_LIMIT_PORT_3)|(1<<MIN_LIMIT_BIT_4)|(1<<MAX_LIMIT_PORT_4)) // All limit bits
  // #else
  //   #define LIMIT_MASK ((1<<MIN_LIMIT_BIT_0)|(1<<MAX_LIMIT_PORT_0)|(1<<MIN_LIMIT_BIT_1)|(1<<MAX_LIMIT_PORT_1)|(1<<MIN_LIMIT_BIT_2)|(1<<MAX_LIMIT_PORT_2))
  // #endif
  ...
  //#define ENABLE_GRBLDUINO_HW_LIMITS

  // Define spindle enable and spindle direction output pins.
  #define SPINDLE_ENABLE_DDR      DDRH
  #define SPINDLE_ENABLE_PORT     PORTH
  #define SPINDLE_ENABLE_BIT      3 // MEGA2560 Digital Pin 6 (D6)
  #define SPINDLE_DIRECTION_DDR   DDRE
  #define SPINDLE_DIRECTION_PORT  PORTE
  #define SPINDLE_DIRECTION_BIT   3 // MEGA2560 Digital Pin 5 (D5)

  // Define flood and mist coolant enable output pins.
  #define COOLANT_FLOOD_DDR   DDRH
  #define COOLANT_FLOOD_PORT  PORTH
  #define COOLANT_FLOOD_BIT   5 // MEGA2560 Digital Pin 8 (D8)
  #define COOLANT_MIST_DDR    DDRH
  #define COOLANT_MIST_PORT   PORTH
  #define COOLANT_MIST_BIT    6 // MEGA2560 Digital Pin 9 (D9)
  ...
  #define SPINDLE_PWM_MAX_VALUE     100.0  // Translates to about 20 kHz PWM frequency with 1/8 prescaler (1<<CS41)
  ...
  // no prescaler, 16-bit Fast PWM mode
  #define SPINDLE_TCCRA_INIT_MASK ((1<<WGM40) | (1<<WGM41))
  #define SPINDLE_TCCRB_INIT_MASK ((1<<WGM42) | (1<<WGM43) | (1<<CS41))
  #define SPINDLE_OCRA_REGISTER   OCR4A // 16-bit Fast PWM mode requires top reset value stored here.
  #define SPINDLE_OCRA_TOP_VALUE  0x0064 // PWM counter reset value. Should be the same as PWM_MAX_VALUE in hex.
  ...
  #define SPINDLE_PWM_MAX_VALUE     1024.0 // Translates to about 16 kHz PWM frequency without prescaler
  #ifndef SPINDLE_PWM_MIN_VALUE
    #define SPINDLE_PWM_MIN_VALUE   1   // Must be greater than zero.
  #endif
  #define SPINDLE_PWM_OFF_VALUE     0
  ...
  // no prescaler, 16-bit Fast PWM mode
  #define SPINDLE_TCCRA_INIT_MASK ((1<<WGM40) | (1<<WGM41))
  #define SPINDLE_TCCRB_INIT_MASK ((1<<WGM42) | (1<<WGM43) | (1<<CS40)) // 16 kHz
  #define SPINDLE_OCRA_REGISTER   OCR4A // 16-bit Fast PWM mode requires top reset value stored here.

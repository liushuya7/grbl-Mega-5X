...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_SPINDLE_RPM_MAX 100.0 // rpm, power percentage for laser
  ...
  #define UNIT_PER_REV_AXIS1 (18.6555 * 3.14159265359) // mm
  ...
  #define DEFAULT_AXIS1_MAX_TRAVEL 280.0 // mm
  ...
  #define DEFAULT_AXIS3_MAX_TRAVEL 65.0 // mm
      ...
      #define DEFAULT_AXIS4_STEPS_PER_UNIT 57.48 // Direct drive : (200 pas par tours * 1/16 microsteps)/360°
      #define DEFAULT_AXIS4_MAX_RATE 5000 // °/mn
      #define DEFAULT_AXIS4_ACCELERATION (300.0*60*60) // 100*60*60 mm/min^2 = 100 mm/sec^2
    ...
    #endif
  #endif
  #define DEFAULT_SPINDLE_RPM_MAX 100 // laser power percentage
